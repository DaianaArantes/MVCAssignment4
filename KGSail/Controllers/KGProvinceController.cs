...
{
    public class KGProvinceController : Controller
    {
        private readonly SailContext _context;

        public KGProvinceController(SailContext context)
        {
            _context = context;
        }
